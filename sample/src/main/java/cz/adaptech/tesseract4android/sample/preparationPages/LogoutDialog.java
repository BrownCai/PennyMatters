...
public class LogoutDialog extends Dialog {
    ...
    private LogoutDialog(@NonNull Context context, String title, String message, String confirmText, String cancelText,
    ...
    public static class Builder {
        ...
        public LogoutDialog build() {
            return new LogoutDialog(mContext, mTitle, mMessage, mConfirmText, mCancelText,
